...
XmlDocGen.Core | A layered class library for generating documentation from .NET XML documentation comments. | [![NuGet](https://img.shields.io/nuget/v/XmlDocGen.Core.svg)](https://www.nuget.org/packages/XmlDocGen.Core)
